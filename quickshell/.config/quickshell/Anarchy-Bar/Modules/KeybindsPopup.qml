...
Item {
    ...
    property bool isOpen: keybindsPopup.isOpen
    property var hyprCategories: []
    property var kittyBinds: []

    function close() { keybindsPopup.close() }
    ...
    function parseKittyBinds(content) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            if (inBindsSection && line.startsWith("#") && line !== "#Binds") break
    ...
    Variants {
        ...
        PanelWindow {
            ...
            property bool isTargetScreen: keybindsPopup.targetScreen === modelData.name
            ...
            Item {
                ...
                Rectangle {
                    ...
                    border { color: theme.muted; width: root.popupBorderThickness }
