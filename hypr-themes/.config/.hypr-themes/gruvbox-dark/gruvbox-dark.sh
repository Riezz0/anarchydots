...
cp -r "$THEME_DIR/arch-gruvbox-dark.png" "/home/$USER/.config/quickshell/assets/arch.png"
cp "$THEME_DIR/arch-gruvbox-dark.png" "$HOME/.config/quickshell/Anarchy-Bar/Assets/arch.png"
